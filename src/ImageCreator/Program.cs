    ...
    class MyForm : Form
    {
        ...
        private void pictureBox_Preview_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (image != null)
            {
                ...
                image.Width * trackBar_Quality.Value / 100,
                image.Height * trackBar_Quality.Value / 100);
        ...
        private void button_Build_Click(object sender, EventArgs e)
        {
            ...
            System.Windows.Forms.MessageBox.Show("以复制到剪贴板,平均花费box数量:" + boxsize / count);
        }
